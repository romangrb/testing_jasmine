 ...
 * we donтАЩt want to send {@link https://developer.mozilla.org/en/xmlhttprequest XHR} or
  ...
  <pre>
    ...
    describe('MyController', function() {
       ...
       it('should send msg to server', function() {
         ...
         // now you donтАЩt care about the authentication, but
...
function createHttpBackendMock($rootScope, $delegate, $browser) {
   ...
   *    тАУ The respond method takes a set of static data to be returned or a function that can return
 ...
 *    an array containing response status (number), response data (string) and response headers
 *    (Object).
 *  - passThrough тАУ `{function()}` тАУ Any request matching a backend definition with `passThrough`
